...
class NiftyTopRatedPage extends StatefulWidget {
  const NiftyTopRatedPage({super.key});

  @override
  State<NiftyTopRatedPage> createState() => _NiftyTopRatedPageState();
}

class _NiftyTopRatedPageState extends State<NiftyTopRatedPage> {
  ...
  void _toggleTracking() {
    ...
    final text = _isTracking
        ? 'Nifty 50 Index Direct is now in your tracked funds.'
        : 'Tracking removed for Nifty 50 Index Direct.';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Nifty Index Top Rated',
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            _card('Nifty 50 Index Direct', 'Rating: 4★ • Consistency: 86%',
                '1Y: 17.6% • 3Y: 16.9% • Expense: 0.21%'),
            const SizedBox(height: 12),
            _buildTrackingCard(),
            const SizedBox(height: 12),
            _card('Benchmark Fit', 'Tracks Nifty 50 with low tracking error',
                'Low-cost choice for passive equity allocation'),
          ],
        ),
      ),
    );
