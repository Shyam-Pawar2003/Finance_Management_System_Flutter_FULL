...
class ParagTrackTopRatedPage extends StatefulWidget {
  const ParagTrackTopRatedPage({super.key});

  @override
  State<ParagTrackTopRatedPage> createState() => _ParagTrackTopRatedPageState();
}

class _ParagTrackTopRatedPageState extends State<ParagTrackTopRatedPage> {
  ...
  void _toggleTracking() {
    ...
    final text = _isTracking
        ? 'Parag Parikh Flexi Cap is now in your tracked funds.'
        : 'Tracking removed for Parag Parikh Flexi Cap.';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Parag Top Rated',
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            _card('Parag Parikh Flexi Cap', 'Rating: 5★ • Consistency: 92%',
                '1Y: 19.1% • 3Y: 18.3% • Expense: 0.74%'),
            const SizedBox(height: 12),
            _buildTrackingCard(),
            const SizedBox(height: 12),
            _card('Tracking Focus', 'Strong risk-adjusted track record',
                'Downside Capture: 72% • Suitable for core equity exposure'),
          ],
        ),
      ),
    );
