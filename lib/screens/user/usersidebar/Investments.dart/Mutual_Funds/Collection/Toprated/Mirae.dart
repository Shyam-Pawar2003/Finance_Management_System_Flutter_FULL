...
class MiraeTopRatedPage extends StatefulWidget {
  const MiraeTopRatedPage({super.key});

  @override
  State<MiraeTopRatedPage> createState() => _MiraeTopRatedPageState();
}

class _MiraeTopRatedPageState extends State<MiraeTopRatedPage> {
  ...
  void _toggleTracking() {
    ...
    final text = _isTracking
        ? 'Mirae Asset Large Cap is now in your tracked funds.'
        : 'Tracking removed for Mirae Asset Large Cap.';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Mirae Top Rated',
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            _card('Mirae Asset Large Cap', 'Rating: 4★ • Consistency: 84%',
                '1Y: 16.9% • 3Y: 15.4% • Expense: 0.59%'),
            const SizedBox(height: 12),
            _buildTrackingCard(),
            const SizedBox(height: 12),
            _card('Fund Style', 'Large cap focused portfolio',
                'Suitable for disciplined long-term equity investors'),
          ],
        ),
      ),
    );
