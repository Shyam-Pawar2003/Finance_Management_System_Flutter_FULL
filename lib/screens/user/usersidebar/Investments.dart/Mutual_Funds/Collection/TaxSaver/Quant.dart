...
class QuantTaxSaverPage extends StatelessWidget {
  const QuantTaxSaverPage({super.key});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            _card('Quant ELSS Tax Saver', '1Y: 24.7% • 3Y: 19.3% • 5Y: 18.1%',
                'Expense: 0.96% • Risk: High'),
            const SizedBox(height: 12),
            _card(
                'Investor Note',
                'Higher return potential with higher volatility',
                'Best suited for long-term investors with high risk appetite'),
          ],
        ),
      ),
    );
