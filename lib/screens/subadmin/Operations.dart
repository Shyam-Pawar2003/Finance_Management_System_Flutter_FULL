...
class _SubAdminOperationsPageState extends State<SubAdminOperationsPage> {
	...
	final List<_OperationsAlert> _alerts = const [
		_OperationsAlert(
			...
			subtitle: 'Capacity gaps need reassignment before tomorrow morning handoff.',
				...
				children: [
					...
					Wrap(
						...
						children: [
							...
							_detailChip(Icons.groups_outlined,
									'${initiative.impactedTeams} teams'),
							_detailChip(Icons.block_outlined,
									'${initiative.blockers} blockers'),
							_detailChip(
				...
				_panel(
					...
					child: Column(
						...
						children: [
							...
							const SizedBox(height: 8),
							_signalRow('Queue reviews pending', '6 pending', const Color(0xFFF29900)),
							const SizedBox(height: 8),
