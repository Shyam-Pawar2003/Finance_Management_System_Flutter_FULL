    ...
    final actions = Wrap(
      ...
      children: [
        OutlinedButton.icon(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Legal summary export started.')),
            );
          },
        ...
        FilledButton.icon(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Risk review queue opened.')),
            );
          },
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              ...
              _detailChip(
                  Icons.folder_open_outlined, '${initiative.matters} matters'),
        ...
        _panel(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              _signalRow('Contract approvals pending', '4 pending',
                  const Color(0xFFDB4437)),
              const SizedBox(height: 8),
              _signalRow('Privacy evidence requests', '3 open',
                  const Color(0xFFF29900)),
              const SizedBox(height: 8),
              _signalRow('Policy updates published', '9 this month',
