...
class _SubAdminHRPageState extends State<SubAdminHRPage> {
      ...
      children: [
        OutlinedButton.icon(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('HR summary export started.')),
            );
          },
        ...
        FilledButton.icon(
          onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('People operations review opened.'),
              ),
            );
          },
  ...
  Widget _buildOperationsPanel(
      List<_HRInitiative> initiatives, bool isCompact) {
    return _panel(
        ...
        _panel(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 10),
              _signalRow('Interview scheduling backlog', '7 pending',
                  const Color(0xFFDB4437)),
              const SizedBox(height: 8),
              _signalRow('Review calibrations remaining', '3 teams',
                  const Color(0xFFF29900)),
              const SizedBox(height: 8),
              _signalRow(
                  'Onboarding completions', '96%', const Color(0xFF1A73E8)),
            ],
          ),
        ),
        const SizedBox(height: 14),
